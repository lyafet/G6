      ...
      if (i[r] !== t) {
        ...
        if (
          ...
          (k = k === t || "" === k ? "" : "margin-top:" + k + ";"),
            ...
            (i[r].rsFullWidthWrap = i[r].topc = e(
    ...
    v = function (a) {
      ...
      for (var o = 0; o < i[a].slides.length; o++) {
        ...
        n.detach(),
          l.detach(),
          ((i[a].startWithSlide != t &&
            i.gA(i[a].slides[o], "originalindex") == i[a].startWithSlide) ||
            (i[a].startWithSlide === t && 0 == o)) &&
            (i[a].pr_next_key = s.index()),
          tpGS.gsap.set(s, {
            width: "100%",
            height: "100%",
            overflow: "hidden",
        ...
        var d = e(i.closestNode(n[0], "RS-SBG-WRAP")),
          ...
          m =
            p.bgcolor !== t && p.bgcolor.indexOf("gradient") >= 0
        ...
        (p.src = n[0].src),
          ...
          l.length > 0 &&
            ...
            l.appendTo(d),
            p.parallax != t &&
              (l.data("parallax", p.parallax),
              l.data("showcoveronpause", "on"),
        ...
        var h = e(
          "<rs-sbg " +
            (p.lazyload !== t ? 'data-lazyload="' + p.lazyload + '"' : "") +
            ' src="' +
            p.src +
            '" class="' +
            c +
      ...
      if (i[a].progressC === t || 0 == i[a].progressC.length)
        if (
          ...
          (i[a].progressC[0].innerHTML =
            ...
            !0 === i[a].noDetach && i[a].c.append(i[a].progressC),
            (i[a].progressCBarInner = i[a].progressC[0].getElementsByClassName(
              "rs-progress-bar"
            )[0]),
              ...
              if (
                ...
                if (
                  ...
                  -1 != d[0].className.indexOf("rs-fsv") || k
                    ...
                    : ((T =
                        "auto" === T && void 0 !== p.vd && "auto" !== L
                          ? "100%" === L
                            ? d.width() / p.vd
                            : L / p.vd
                          : T),
                      (p.vidOBJ = { width: L, height: T })),
                    ((0 == p.html5vid && !k) ||
                      (1 != p.forcecover && !d.hasClass("rs-fsv") && !k)) &&
                      (p.mediaOBJ = { width: L, height: T, display: "block" }),
                    p._ingroup &&
                      null !== p.vidOBJ.width &&
                      void 0 !== p.vidOBJ.width &&
                      !o.isNumeric(p.vidOBJ.width) &&
                      p.vidOBJ.width.indexOf("%") > 0 &&
                      (p.OBJUPD.lppmOBJ = { minWidth: L });
                else {
                  var R = d.width(),
                    O = "auto" === T ? R / p.vd : T;
            ...
            if ("preset" !== e.mode) {
              ...
              (1 == o[r].gridEQModule ||
                (void 0 !== p._lig &&
                  ...
                  "column" !== p.type &&
                  "group" !== p.type)) &&
                ((M = void 0 !== p._lig ? p._lig.width() : o[r].module.width),
            ...
            ? (o[t].layers.individual =
                void 0 === o[t].layers.individual
                  ? "all" === o[t].carousel.showLayersAllTime
                    ? R(jQuery(o[t].c), "rs-layer", "rs-layer-static")
                    : R(jQuery(o[t].c), "rs-on-car")
                  : o[t].layers.individual)
            : ((o[t].layers[i] =
                void 0 === o[t].layers[i]
                  ? "all" === o[t].carousel.showLayersAllTime
              ...
              (o[t].sbas[i] =
                void 0 === o[t].sbas[i]
                  ? R(jQuery(o[t].slides[e.slide]), "rs-sba")
                  : o[t].sbas[i]));
        var r =
          "rebuild" === e.mode &&
          "carousel" === o[t].sliderType &&
          ...
          if (
            ...
            if (
              ...
              if (
                "continue" === e.mode &&
                "frame_999" === e.frame &&
                (T || void 0 === h.lastRequestedMainFrame)
              )
                return;
            } else {
          ...
          h.ford))
            if (h.ford.hasOwnProperty(R)) {
              ...
              if ("frame_0" !== O && "frame_hover" !== O && "loop" !== O) {
                if (
                  ("frame_999" === O &&
                    !h.frames[O].timeline.waitoncall &&
                    h.frames[O].timeline.start >= o[r].duration &&
                    !0 !== e.remove &&
                    (h.frames[O].timeline.waitoncall = !0),
                  "start" === e.mode &&
                    "keep" !== h.triggercache &&
                    (h.frames[O].timeline.callstate = h.frames[O].timeline
                      .waitoncall
                      ? "waiting"
                      : ""),
                  "trigger" === e.mode &&
                    h.frames[O].timeline.waitoncall &&
                    (O === e.frame
                      ? ((h.frames[O].timeline.triggered = !0),
                        (h.frames[O].timeline.callstate = "called"))
                      : (h.frames[O].timeline.triggered = !1)),
                  "rebuild" === e.mode ||
                    h.frames[O].timeline.triggered ||
                    (h.frames[O].timeline.callstate = h.frames[O].timeline
                      .waitoncall
                      ? "waiting"
                      : ""),
                  ...
                  if (
                    ...
                    continue;
                  (O === e.frame ||
                    ("rebuild" === e.mode && O === h.triggeredFrame)) &&
                    (y = !0);
                } else O === e.frame && (y = !0);
                if (
                  (O !== e.frame &&
                    h.frames[O].timeline.waitoncall &&
                    "called" !== h.frames[O].timeline.callstate &&
                    (v = !0),
                  O !== e.frame &&
                    y &&
                    (v =
                      !0 === v && h.frames[O].timeline.waitoncall
                        ? "skiprest"
                        : !0 !== v && v),
                  ...
                  v &&
                    "waiting" === h.frames[O].timeline.callstate &&
                    "preset" === e.mode &&
                ...
                if (
                  ...
                  var I = h.frames[O],
                    ...
                    B = h.c,
                    M =
                      void 0 !== I.sfx && w(I.sfx.effect, h.m, I.timeline.ease),
                      ...
                      if (void 0 !== I[t[E]] && !h.quickRendering) {
                        var V = h.splitText[t[E]],
                          ...
                          Q = h.fff
                            ...
                            : void 0,
                          X = h.frames[O].dosplit
                            ? void 0 === I[t[E]].delay
                              ? 0.05
                              : I[t[E]].delay / 100
                            : 0;
                        (h.color[s] === N.color && "frame_1" === O) ||
                          (Y.color = N.color),
                          void 0 !== H &&
                            h.color[s] !== H.color &&
                            (Q.color = H.color),
                  ...
                  if (
                    ...
                    z.add(tpGS.gsap.to(h.m, 0.001, { overflow: "hidden" }), 0),
                      ...
                      h.fff
                        ...
                        : z.add(
                            tpGS.gsap.to([h.m, h.cbgmask], G, o.clone(W)),
                            0.001
                          );
                    ...
                    (0 === h.btrans.rX && 0 == h.btrans.rY) ||
                      ...
                      z.add(tpGS.gsap.to(h.m, 0.001, Z), 0);
                  } else
                    z.add(
              ...
              (("trigger" !== e.mode && "frame_999" !== e.frame) ||
                ...
                l(de) &&
                  h.loop.move.to(
                    ...
                    { motionPath: de, ease: h.frames.loop.timeline.ease }
                  );
            } else
              (("trigger" !== e.mode && "frame_999" !== e.frame) ||
                "frame_999" !== e.frame) &&
                          ...
                          0 == h.hovertimeline.progress() &&
                            ...
                            "column" === h.type &&
                              h.hovertimeline.to(
                                h.cbg,
                                ge,
                                o.clone(m(h.frames.frame_hover, h.cbg)),
                                0
                              ),
                            ("text" !== h.type && "button" !== h.type) ||
                              void 0 === h.splitText ||
                            ...
                            "column" === h.type
                              ? h.hovertimeline.to(
                                  h.c,
                                  ge,
                                  n(o.clone(m(h.frames.frame_hover, h.c))),
                                  0
                                )
                              : h.hovertimeline.to(
                                  h.c,
                                  ge,
                                  o.clone(m(h.frames.frame_hover, h.c)),
                                  0
                                ),
                            "svg" === h.type))
                        ) {
              ...
              if (void 0 === h.childrenJS)
                for (var E in ((h.childrenJS = {}), o[r]._L))
                  void 0 !== o[r]._L[E]._lig &&
                    ...
                    (h.childrenJS[o[r]._L[E].c[0].id] = o[r]._L[E].c);
    ...
    var n = function (e) {
          ...
          if (a.hasOwnProperty(l)) {
            if (
              ...
              switch (
                ...
                case "left":
                  a[l] =
                    0 - (i.eow || 0) - ("column" === i.type ? 0 : i.calcx || 0);
                  break;
                case "r":
                case "right":
      ...
      S = function (e, t) {
        ...
        return (
          e.resetfilter &&
            ...
            (i.frame_0.filter.blur =
              void 0 === i.frame_0.filter.blur ? 0 : i.frame_0.filter.blur),
            (i.frame_0.filter.brightness =
              void 0 === i.frame_0.filter.brightness
                ? 100
                : i.frame_0.filter.brightness),
            (i.frame_0.filter.grayscale =
      ...
      A = function (e, t, s) {
        ...
        var c =
            ...
            O(o[s].computedStyle[e[0].id].fontWeight) ==
              O(o[s].computedStyle[d[0].id].fontWeight) &&
        ...
        for (
          ...
          I(l["padding" + i[n]], 0) && delete l["padding" + i[n]],
            ...
            I(l["border" + a[n] + "Radius"], "0px")
              ? delete l["border" + a[n] + "Radius"]
              : I(l["border" + a[n] + "Radius"], "0") &&
                delete l["border" + a[n] + "Radius"];
        ...
        if (-1 === k.indexOf("rs_splitted_")) {
          ...
          if (
            ...
            ("shape" !== x.type && "image" !== x.type) ||
              !(
                z(e.borderTopLeftRadius) ||
                z(e.borderTopRightRadius) ||
                z(e.borderBottomLeftRadius) ||
                z(e.borderBottomRightRadius)
              ) ||
              (s.overflow = "hidden"),
            x._isnotext ||
              ("column" !== x.type &&
            ...
            t[e].c.rsswipe({
              ...
              fingers:
                t[e].navigation.touch.swipe_min_touches > 5
                  ...
                  : t[e].navigation.touch.swipe_min_touches,
              excludedElements:
                "label, button, input, select, textarea, .noSwipe, .rs-nav-element, .rs-wclickaction",
          ...
          if (
            ...
            switch (c) {
              case 12:
                u &&
                  t[r].mtl.add(
                    tpGS.gsap.to(t[r].pr_active_bg, F, {
                      x: 0 - j + "px",
                      overflow: "hidden",
                      force3D: "auto",
                      scale: X,
